    ...
    <div className="bg-gray-300 min-h-screen flex justify-center py-4">
      <div className="w-full max-w-md mx-auto">
        <header className="flex items-center space-x-2 p-4">
          <Logo />
          <div className="bg-gray-700 text-white font-semibold py-2 px-4 rounded-md shadow-md border-2 border-cyan-400">Augmented Reality Dasar teknik elektronika</div>
        </header>
